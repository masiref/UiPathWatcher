...
return [
    ...
    */
    'resources' => [
        ...
        'alert-trigger-rules' => \App\AlertTriggerRule::class,
        'watched-automated-processes' => \App\WatchedAutomatedProcess::class,
        'clients' => \App\Client::class,
        'ui-path-orchestrators' => \App\UiPathOrchestrator::class,
        'ui-path-robots' => \App\UiPathRobot::class,
        'ui-path-processes' => \App\UiPathProcess::class,
        'ui-path-queues' => \App\UiPathQueue::class,
