<div class="steps-content">
    <div class="step-content process-selection is-active">
        @include('configuration.alert-trigger.steps.content.watched-process-selection')
    </div>
    <div class="step-content trigger-details">
