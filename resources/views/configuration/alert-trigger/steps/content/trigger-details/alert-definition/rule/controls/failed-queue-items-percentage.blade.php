        ...
        <div class="field">
            <p class="control is-expanded has-icons-left has-icons-right has-tooltip-bottom"
                ...
                <input class="input is-danger trigger-details--alert-definition--rule--parameter
                    trigger-details--alert-definition--failed-queue-items-percentage-rule--minimal-percentage-input"
                    type="text" placeholder="Minimal failed queue items percentage">
