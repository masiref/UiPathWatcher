    ...
    <div class="field-body">
        <div class="field">
            <p class="control is-expanded has-icons-left"
                ...
                trigger-details--alert-definition--kibana-metric-visualization-rule--lower-count-input"
        ...
        <div class="field">
            <p class="control is-expanded has-icons-left has-tooltip-bottom"
                ...
                <input class="input is-danger trigger-details--alert-definition--rule--parameter
                trigger-details--alert-definition--kibana-metric-visualization-rule--higher-count-input"
