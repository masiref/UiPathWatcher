                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_monday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_monday ? 'disabled' : '' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_tuesday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_tuesday ? 'disabled' : '' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_wednesday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_wednesday ? 'disabled' : '' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_thursday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_thursday ? 'disabled' : '' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_friday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_friday ? 'disabled' : '' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_saturday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_saturday ? 'disabled' : '' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_sunday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_sunday ? 'disabled' : '' !!}>
