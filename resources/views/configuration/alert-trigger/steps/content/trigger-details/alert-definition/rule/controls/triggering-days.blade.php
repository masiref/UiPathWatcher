                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_monday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_monday ? 'disabled' : 'checked="checked"' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_tuesday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_tuesday ? 'disabled' : 'checked="checked"' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_wednesday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_wednesday ? 'disabled' : 'checked="checked"' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_thursday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_thursday ? 'disabled' : 'checked="checked"' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_friday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_friday ? 'disabled' : 'checked="checked"' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_saturday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_saturday ? 'disabled' : 'checked="checked"' !!}>
                    ...
                    <div class="column">
                        <p class="control">
                            <input type="checkbox" id="{{ $uniqid }}-triggering_day_sunday"
                                ...
                                {!! !$watchedAutomatedProcess->running_period_sunday ? 'disabled' : 'checked="checked"' !!}>
