<div class="edit-form-section" style="display: none;">
    @include('layouts.title', [
        'title' => 'Edit an orchestrator',
        'icon' => 'edit',
        'color' => 'primary'
    ])
            
    <form id="edit-form" data-id="{{ ($orchestrator ?? false) ? $orchestrator->id : '' }}" action="#" onsubmit="return false;">
        @include('configuration.orchestrator.form.controls')
